/**
 * Chat Widget — Dar El-Abrar Travel Assistant
 * AI-powered booking & information assistant for Umrah and travel in KSA
 *
 * Usage:
...
(function (global) {
  ...
  var BRAND = {
    ...
    primaryLight: '#2E7D32',
    primaryDark: '#0D3B11',
    primaryGradient: 'linear-gradient(135deg, #1B5E20, #2E7D32, #388E3C)',
    accent: '#C8A951',
    accentLight: '#E8D5A3',
    accentDark: '#A68A3E',
    bg: '#FFFBF5',
  ...
  var TRANSLATIONS = {
    en: {
      title: "Dar El-Abrar",
      subtitle: "Travel & Umrah Assistant",
      placeholder: "Ask about trips, Umrah, or book a ride...",
      greeting:
        "👋 Welcome to <strong>Dar El-Abrar</strong>! I'm your travel assistant for premium land transportation and buses in Saudi Arabia. 🚌✨<br><br>" +
        "I can help you with:<br>" +
        "📍 Trip information between Makkah, Riyadh & Madinah<br>" +
        "🕌 Umrah guidance and tips<br>" +
        "📋 Booking your bus trip<br>" +
      ...
      bookingRoute: "Travel Route",
      bookingDate: "Travel Date",
      bookingPassengers: "Number of Passengers",
      bookingNotes: "Additional Notes (optional)",
    ...
    ar: {
      title: "دار الأبرار",
      subtitle: "مساعد السفر والعمرة",
      placeholder: "اسأل عن الرحلات، العمرة، أو احجز...",
      greeting:
        "👋 مرحبًا بك في <strong>دار الأبرار</strong>! أنا مساعدك الذكي للسفر والنقل البري الفاخر وحافلات في المملكة العربية السعودية. 🚌✨<br><br>" +
        "يمكنني مساعدتك في:<br>" +
        "📍 معلومات الرحلات بين مكة والرياض والمدينة<br>" +
        "🕌 إرشادات ونصائح للعمرة<br>" +
        "📋 حجز رحلة حافلة<br>" +
  ...
  /* ─── Defaults & State ────────────────────────────────────── */
  var DEFAULTS = {
    apiUrl: 'https://darelabrarchatbot.runasp.net',
    position: 'right',
  ...
  function injectStyles() {
    ...
    var css = [
      '@import url("https://fonts.googleapis.com/css2?family=Noto+Naskh+Arabic:wght@400;600;700&family=Inter:wght@400;500;600;700&display=swap");',
      '',
      ...
      '  box-shadow: 0 4px 24px ' + BRAND.shadow + ';',
      '  z-index: 10000;',
      '  transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.3s;',
      '  display: flex; align-items: center; justify-content: center;',
      '}',
      '#chat-widget-toggle:hover { transform: scale(1.1) rotate(-5deg); box-shadow: 0 6px 32px ' + BRAND.shadow + '; }',
      ...
      '  background: ' + BRAND.bg + '; border-radius: 20px;',
      ...
      '}',
      '.chat-input-area button:hover { transform: scale(1.05); box-shadow: 0 4px 12px rgba(27,94,32,0.35); }',
      ...
      '}',
      '.chat-btn-primary:hover { transform: translateY(-1px); box-shadow: 0 5px 16px rgba(27,94,32,0.35); }',
  ...
  function showBookingForm() {
    ...
    var routeField = createSelect('route', getText('bookingRoute'), [
      ...
      { value: 'medina-to-riyadh', label: getRoute('medinaToRiyadh') }
    ], isRtl);
  ...
  function submitBookingForm(form) {
    ...
    var routeLabels = {
      'mecca-to-riyadh': currentLang === 'ar' ? 'من مكة إلى الرياض' : 'Mecca → Riyadh',
      'riyadh-to-mecca': currentLang === 'ar' ? 'من الرياض إلى مكة' : 'Riyadh → Mecca',
      'medina-to-riyadh': currentLang === 'ar' ? 'من المدينة إلى الرياض' : 'Medina → Riyadh'
    };

    var routeName = routeLabels[route.value] || route.value;
    ...
    msg += '📅 *' + (currentLang === 'ar' ? 'تاريخ السفر' : 'Date') + ':* ' + date.value + '\n';
    ...
    var whatsappUrl = 'https://wa.me/966574262136?text=' + encodeURIComponent(msg);
